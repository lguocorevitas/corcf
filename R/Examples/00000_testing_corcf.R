...
# Example 1, testing UAT/prod raw data: bv_subjects

data_name <-"bv_subjects"

prev_data <- glue("{dir_ra_monthly}/2026/2026-03-01/bv_raw/{data_name}.dta")
current_data  <- glue("{dir_ra_monthly}/2026/2026-04-01//bv_raw/{data_name}.dta")
...
corcf::write_corcf_word(
  ...
  id_cols     = id_cols,
  path = glue("{dir_ra_monthly}/2026/2026-04-01/rewrite/QC/corcf_results_{data_name}_{tdy_date}_verbose.docx"),
  report_date = Sys.Date()
)

# Example 2, Testing RA Analytic data
data_name <-"visits_calc"
test_data <- glue("{dir_ra_monthly}/2026/2026-04-01/rewrite/RA_{data_name}_{cut_date}.dta")
current_data  <- glue("{dir_ra_monthly}/2026/2026-04-01/2_3_keyvisitvars_{cut_date}.dta")
...
corcf::write_corcf_word(
  ...
  id_cols     = id_cols,
  path = glue("{dir_ra_monthly}/2026/2026-04-01/rewrite/QC/corcf_results_{data_name}_{tdy_date}.docx"),
  report_date = Sys.Date()
)
